...
--
* Why is it $(I(n), n\geq 1=$ a Markov chain?
* What is the state space
* Write the transition matrix and the initial probability
* Is there a stationnary distribution ? 
...
$N = 200,$ $I(0) \mathcal{sim} Unif(\left\lbrace{1,2, ....30}\right\rbrace), R(0)=0,$ $pI = 0.02$
